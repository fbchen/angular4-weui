...
module.exports = {
  ...
  "entry": {
    "styles": [
      "./src/app/weui/weui.scss"
    ]
  },
  "output": {
    "path": path.join(process.cwd(), "dist/angular-weui"),
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "src/app/weui/weui.scss")
        ],
        "test": /\.css$/,
        "use": [
  ...
  "plugins": [
    ...
    new GlobCopyWebpackPlugin({
      "patterns": [],
      "globOptions": {
        "cwd": "/Users/fbchen/workspace1/angular4-weui/src/app/weui",
        "dot": true,
        "ignore": "**/.gitkeep"
      }
    }),
    ...
    new HtmlWebpackPlugin({
      "template": "./src/app/weui/index.html",
      "filename": "./index.html",
      "hash": false,
      "inject": true,
      "compile": true,
